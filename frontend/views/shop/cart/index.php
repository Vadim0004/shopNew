...
<div class="cabinet-index">
                    ...
                    <td class="text-left">
                        ...
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <span class="input-group-btn">
                                    <button type="submit" title="" class="btn btn-primary" data-original-title="Update"><i
                                                class="fa fa-refresh"></i></button>
                                    <a title="Remove" class="btn btn-danger"
                                       href="<?= Url::to(['remove', 'id' => $item->getId()]) ?>" data-method="post"><i
    ...
    <div class="buttons clearfix">
        <div class="pull-left"><a href="<?= Url::to('/shop/catalog/index') ?>" class="btn btn-default">Continue
                Shopping</a></div>
        <?php if ($cart->getItems()): ?>
            <div class="pull-right"><a href="index.php?route=checkout/checkout" class="btn btn-primary">Checkout</a>
            </div>
        <?php endif; ?>
    </div>
</div>