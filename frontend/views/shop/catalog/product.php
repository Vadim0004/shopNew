...
<div class="row">
    <div class="col-sm-8">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab-description"><p>
                    ...
                    Monitor. This flagship monitor features best-in-class performance and presentation features on a
                    huge wide-aspect screen while letting you work as comfortably as possible - you might even forget
    ...
    <div class="col-sm-4">
        ...
        <ul class="list-unstyled">
            <li>Brand: <a href="/index.php?route=product/manufacturer/info&amp;manufacturer_id=7">Hewlett-Packard</a>
            </li>
