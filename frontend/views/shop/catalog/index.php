...
<div class="panel panel-default">
    <div class="panel-body">
        <a href="/index.php?route=product/category&amp;path=20_26">PC (0)</a> | <a
                href="/index.php?route=product/category&amp;path=20_27">Mac (1)</a>
    </div>
</div>
    ...
    <div class="col-md-4 col-xs-6">
        <div class="form-group input-group input-group-sm">
            ...
            <select id="input-sort" class="form-control" onchange="location = this.value;">
                ...
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=pd.name&amp;order=ASC">Name (A -
                    Z)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=pd.name&amp;order=DESC">Name (Z -
                    A)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=p.price&amp;order=ASC">Price (Low
                    &gt; High)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=p.price&amp;order=DESC">Price
                    (High &gt; Low)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=rating&amp;order=DESC">Rating
                    (Highest)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=rating&amp;order=ASC">Rating
                    (Lowest)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=p.model&amp;order=ASC">Model (A -
                    Z)
                </option>
                <option value="/index.php?route=product/category&amp;path=20&amp;sort=p.model&amp;order=DESC">Model (Z -
                    A)
                </option>
            </select>
        </div>
    ...
    <div class="col-md-3 col-xs-6">
        <div class="form-group input-group input-group-sm">
            ...
            <select id="input-limit" class="form-control" onchange="location = this.value;">
                <option value="/index.php?route=product/category&amp;path=20&amp;limit=15" selected="selected">15
                </option>
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=42"><img
                            src="http://static.shop.dev/cache/products/apple_cinema_30-228x228.jpg"
                            alt="Apple Cinema 30&quot;" title="Apple Cinema 30&quot;" class="img-responsive"/></a></div>
            <div>
                <div class="caption">
                    <h4><a href="/index.php?route=product/product&amp;path=20&amp;product_id=42">Apple Cinema
                            30&quot;</a></h4>
                    <p>
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=30"><img
                            src="http://static.shop.dev/cache/products/canon_eos_5d_1-228x228.jpg" alt="Canon EOS 5D"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=47"><img
                            src="http://static.shop.dev/cache/products/hp_1-228x228.jpg" alt="HP LP3065"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=28"><img
                            src="http://static.shop.dev/cache/products/htc_touch_hd_1-228x228.jpg" alt="HTC Touch HD"
            ...
            <div>
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('28', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('28');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=40"><img
                            src="http://static.shop.dev/cache/products/iphone_1-228x228.jpg" alt="iPhone" title="iPhone"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=48"><img
                            src="http://static.shop.dev/cache/products/ipod_classic_1-228x228.jpg" alt="iPod Classic"
            ...
            <div>
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('48', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('48');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=43"><img
                            src="http://static.shop.dev/cache/products/macbook_1-228x228.jpg" alt="MacBook"
            ...
            <div>
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('43', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('43');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=44"><img
                            src="http://static.shop.dev/cache/products/macbook_air_1-228x228.jpg" alt="MacBook Air"
                            title="MacBook Air" class="img-responsive"/></a></div>
            <div>
                <div class="caption">
                    <h4><a href="/index.php?route=product/product&amp;path=20&amp;product_id=44">MacBook Air</a></h4>
                    <p>
                        MacBook Air is ultrathin, ultraportable, and ultra unlike anything else. But you don&rsquo;t
                        lose..</p>
                    <p class="price">
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('44', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('44');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=29"><img
                            src="http://static.shop.dev/cache/products/palm_treo_pro_1-228x228.jpg" alt="Palm Treo Pro"
                            title="Palm Treo Pro" class="img-responsive"/></a></div>
            <div>
                <div class="caption">
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('29', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('29');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=33"><img
                            src="http://static.shop.dev/cache/products/samsung_syncmaster_941bw-228x228.jpg"
                            alt="Samsung SyncMaster 941BW" title="Samsung SyncMaster 941BW" class="img-responsive"/></a>
            </div>
            <div>
                <div class="caption">
                    <h4><a href="/index.php?route=product/product&amp;path=20&amp;product_id=33">Samsung SyncMaster
                            941BW</a></h4>
                    <p>
                        Imagine the advantages of going big without slowing down. The big 19&quot; 941BW monitor
                        combines..</p>
                    <p class="price">
                ...
                <div class="button-group">
                    <button type="button" onclick="cart.add('33', '1');"><i class="fa fa-shopping-cart"></i> <span
                                class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
                    <button type="button" data-toggle="tooltip" title="Add to Wish List" onclick="wishlist.add('33');">
                        <i class="fa fa-heart"></i></button>
                    <button type="button" data-toggle="tooltip" title="Compare this Product"
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=46"><img
                            src="http://static.shop.dev/cache/products/sony_vaio_1-228x228.jpg" alt="Sony VAIO"
                            title="Sony VAIO" class="img-responsive"/></a></div>
            <div>
                <div class="caption">
                    <h4><a href="/index.php?route=product/product&amp;path=20&amp;product_id=46">Sony VAIO</a></h4>
                    <p>
                        Unprecedented power. The next generation of processing technology has arrived. Built into the
                        new..</p>
                    <p class="price">
                        $1,202.00 <span class="price-tax">Ex Tax: $1,000.00</span>
                    </p>
