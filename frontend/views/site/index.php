...
use frontend\widgets\shop\ShuffleJsWidget;
use yii\web\View;

?>

<?php $shuffle = ShuffleJsWidget::begin([
    'id' => 'shuffleJs',
    'clientOptions' => [
        'element' => 'grid',
        ...
        <div id="grid" class="row my-shuffle-container">
                ...
                <div class="picture-item__inner">
                    ...
                    <div class="picture-item__details">
                        <figcaption class="picture-item__title"><a href="https://unsplash.com/photos/RRNbMiPmTZY"
                                                                   target="_blank" rel="noopener">Golden Gate Bridge</a>
                        </figcaption>
            ...
            <figure class="col-3@xs col-4@sm col-3@md picture-item picture-item--h2" data-groups='["space"]'
                ...
                <div class="picture-item__inner">
                    ...
                    <p class="picture-item__description">SpaceX launches a Falcon 9 rocket from Cape Canaveral Air Force
                        Station</p>
                </div>
            </figure>
...
<?php ShuffleJsWidget::end(); ?>

<?php $this->registerJs("
class Search {
  constructor() {
    this.shuffle = {$shuffle->options['id']}
